    ...
    <section id="servicios" className="py-24 bg-background relative">
      <div className="container mx-auto px-4" ref={ref}>
        ...
        <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-6 mb-20">
          {[
            ...
            <motion.div
              ...
              className={`p-8 rounded-2xl bg-gradient-to-br ${area.color} border border-border hover:border-primary/30 transition-all group`}
            >
        ...
        <motion.div
          ...
          className="bg-card rounded-3xl p-8 md:p-12 border border-border overflow-hidden"
        >
